...
namespace CapaPresentacionAdmin.Controllers
{
    public class AccesoController : Controller
    {
        ...
        public ActionResult Index(string correo, string clave)
        {
            ...
            oUsuario = new CN_Usuarios().Listar().Where(u => u.Correo == correo && u.Clave == CN_Recursos.ConvertirShat256(clave)).FirstOrDefault();
        ...
        public ActionResult Reestablecer(string correo)
        {
            ...
            if (oUsuario == null)
            {
                ViewBag.Error = "No existe un usuario relacionado a ese correo!";
                return View();
            }
